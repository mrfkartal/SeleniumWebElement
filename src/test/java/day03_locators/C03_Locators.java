...
public class C03_Locators {
    ...
    public static void main(String[] args) {
       ...
       signInLinki.click();
        ...
        //  c. email textbox,password textbox, and signin button elementlerini locate ediniz..
        WebElement emailTextBox=driver.findElement(By.id("session_email")); //mail kutusuna sag tikla incele

        WebElement passwordTextBox=driver.findElement(By.name("session[password]")); //sifre kutusuna
        WebElement signInButonu= driver.findElement(By.name("commit")); //sign tusuna sag tikla inlce
        ...
        if(adressesElementi.isDisplayed()){ //bir elementinın gorunup olup olmadıgını test etkme ıcın (devamı asagıda)
            System.out.println("adresses testi PASSED");       //isDisplayed() yazarız bıze BOOLEN IFADE DONDURUR
        } else {
